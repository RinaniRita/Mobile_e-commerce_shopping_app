...
@Composable
fun OrderInfoOnTheWayScreen(
    navController: NavHostController,
    viewModel: OrderInfoViewModel = viewModel()
) {
    LaunchedEffect(Unit) {
        viewModel.loadScenario(OrderInfoScenario.ON_THE_WAY_SAMPLE)
    }
    ...
    Scaffold(
        ...
        Column(
            ...
            // Bottom actions (on the way - single button)
            Button(
...
@Composable
fun OrderInfoOnTheWayScreenPreview() {
    Uwe_shopping_appTheme {
        OrderInfoOnTheWayScreen(
